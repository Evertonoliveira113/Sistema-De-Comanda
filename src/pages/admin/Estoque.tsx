...
import { AlertCircle, Package, RefreshCw, ArrowUp, ArrowDown, Search } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-[16px] border border-zinc-200 bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredInventory.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-zinc-500 font-semibold">Nenhum produto encontrado</p>
              <p className="text-zinc-400 text-sm">Tente outro termo de busca</p>
            </div>
          ) : (
