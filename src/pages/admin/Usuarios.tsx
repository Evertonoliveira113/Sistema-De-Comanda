...
import { UserPlus, Shield, Mail, Trash2, Edit2, Lock, CheckCircle2, X } from 'lucide-react';
              ...
              <form onSubmit={handleUpdateUser} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-3">
                    <button
                      type="button"
                      onClick={() => setEditingUser({ ...editingUser, ativo: true })}
                      className={cn(
                        "flex-1 p-4 rounded-2xl font-bold uppercase tracking-widest transition-all border-2",
                        editingUser.ativo 
                    ...
                    <button
                      type="button"
                      onClick={() => setEditingUser({ ...editingUser, ativo: false })}
                      className={cn(
                        "flex-1 p-4 rounded-2xl font-bold uppercase tracking-widest transition-all border-2",
                        !editingUser.ativo 
            ...
            <div key={user.id} className="bg-white p-6 rounded-[32px] border border-zinc-100 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-zinc-50 rounded-xl">
                  ...
                  <span className="bg-orange-100 text-orange-600 px-3 py-1 rounded-lg font-bold text-sm uppercase tracking-widest">
                    {user.role === 'admin' ? 'Admin' : 'Garçom'}
                  </span>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  >
                    {user.ativo ? (
                      <><Lock size={18} className="mr-2" /> Bloquear</>
                    ) : (
