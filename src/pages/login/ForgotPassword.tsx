...
import { Flame, Mail, ChevronLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-zinc-400 mt-2">Recuperar Senha</p>
        </div>
        ...
        {success ? (
          ...
          >
            ...
            <h2 className="text-xl font-bold text-emerald-900">Email Enviado!</h2>
